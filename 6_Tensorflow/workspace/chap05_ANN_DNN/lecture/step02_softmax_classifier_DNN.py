...
# 75 vs 25
x_train, x_test, y_train, y_test = train_test_split(y_data, y_data) 
...
# hidden layer2 : 2층 // 2층 입장에선 1층이 입력
...
w3 = tf.Variable(tf.random_normal([hidden2_node, 3])) #[input, output]
