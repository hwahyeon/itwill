...
#피어슨 상관계수 R에 따라서 0.4992086는 다소 높은 양의 상관관계라 할 수 있다.
...
# 대각선 1은 자기와 비교하는 것이기 때문에 상관계수가 1이 나옴.
...
score_iq = read.csv(file.choose()) #score_iq
head(score_iq)
...
#score, iq는 높은 상관성을 보인다.

cor(score_iq[-1]) #0.88222034  0.8962647
