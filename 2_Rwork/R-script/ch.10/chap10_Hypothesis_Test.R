...
# 2. 기각역의 평균 검정
t.test(x, mu=165.1)
# 귀무가설 : 평균키가 165.1cm 차이가 없다.(x) <- 기각이유

# t = 6.3738, df = 999
#p-value = 2.811e-10 < 알파(0.05)
# alternative hypothesis: true mean is not equal to 165.1
# 95 percent confidence interval:
#   165.1695 165.2314 : 기각역
# sample estimates:
#   mean of x 
# 165.2004 
