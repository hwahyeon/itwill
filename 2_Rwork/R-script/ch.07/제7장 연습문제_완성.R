...
library(reshape2)
# 고객별 반품현황 : 집계합수(length)
return_code <- dcast(return_data, user_id ~ return_code, 
                     length)
return_code
#     user_id 1 2 3 4
# 1      1008 1 0 0 0
...
# 칼럼수정 
names(return_code) <- c("user_id", "return_code1","return_code2",
                        "return_code3","return_code4")
